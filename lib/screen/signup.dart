...
class SignupForm extends StatefulWidget {
  ...
  const SignupForm(this.show, {super.key});
        ...
        body: SafeArea(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              textfield(confirm_password, _focusNode3, 'Confirm Password',
                  Icons.password),
              SizedBox(
                height: 8,
              ),
      ...
      child: GestureDetector(
        onTap: () {
          AuthenticationRemote()
              .register(email.text, password.text, confirm_password.text);
        },
        child: Container(
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              prefixIcon: Icon(
                iconss,
                color: _focusNode.hasFocus ? custom1 : custom_green,
              ),
              contentPadding:
